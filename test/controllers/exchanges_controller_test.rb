...
class ExchangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post exchanges_url, params: { exchange: { amount: @exchange.amount, exchange_date: @exchange.exchange_date, type: @exchange.type, user_id: @exchange.user_id } }
    end
  ...
  test "should update exchange" do
    patch exchange_url(@exchange), params: { exchange: { amount: @exchange.amount, exchange_date: @exchange.exchange_date, type: @exchange.type, user_id: @exchange.user_id } }
